...
<div class="right_col" role="main">
    ...
    <div class="row" id="oculatFrmEditarMaterial" style="display: none;">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Material <small>Editar datos de un material en específico.</small></h2>
                        ...
                        <form id="frmModificarMaterial" action="" method="POST" class="form-horizontal form-label-left">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="input-group">                                        
                                        <input type="text" class="form-control" id="fichatecnica" name="fichatecnica" readonly="" placeholder="Seleccionar ficha técnica">
                                        <span class="input-group-btn" aria-hidden="true">
    ...
    <div class="row" id="oculatFrmListadoMaterial">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Materiales <small>lista de materiales por ficha técnica.</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
                        ...
                        <form class="form-inline" method="POST">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" maxlength="10" class="form-control" id="ficha_tecnica" name="ficha_tecnica" placeholder="Ingresar ficha técnica" required="">                                
                                </div>
                            </div>                            
