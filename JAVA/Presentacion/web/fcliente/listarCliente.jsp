...
<div class="right_col" role="main">        
    ...
    <div class="row" id="oculatFrmEditarCliente"style="display: none;">
        <!-- Cliente -->
        <div class="col-md-12 col-sm-12 col-xs-12">    
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form id="frmModificarCliente" action="" method="POST" class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="checkbox">
                                        <label>
                                            <input id="estadocliente" name="estadocliente" type="checkbox" value=""> Opción para habilitar un modelo.
                                        </label>
                                    </div>                        
                                </div>
                            </div>
    ...
    <div class="row" id="oculatFrmListadoCliente">
        <div class="col-md-12 col-sm-12 col-xs-12">
