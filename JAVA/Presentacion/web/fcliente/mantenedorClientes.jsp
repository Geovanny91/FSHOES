...
<div class="right_col" role="main">        
    ...
    <div class="row">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Formulario Cliente <small>registrar datos.</small></h2>
                ...
                <form id="frmCliente" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control"  name="razon" id="razon" placeholder="Ingresar razón social">
                        </div>
                    </div>                    
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Ruc</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" maxlength="11" name="ruc" id="ruc" value="" placeholder="Ingresar ruc" required="">
                        </div>
                    </div>
                    <div class="form-group">
